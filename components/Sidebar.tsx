        ...
        {navItems.map((item) => {
          ...
          return (
            <button
              ...
              onClick={() => {
                onNavigate(item.id);
                // On mobile, auto-close after selection for better UX
                if (window.innerWidth < 768) onClose();
              }}
              className={`w-full flex items-center justify-start p-3 px-4 rounded-xl transition-all duration-300 group relative overflow-hidden ${
                isActive 
