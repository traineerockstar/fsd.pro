        ...
        return (
            <div className="max-w-6xl mx-auto space-y-12">
                <header className="space-y-4 mb-16">
                    ...
                    <p className="text-slate-400 text-lg font-light max-w-2xl leading-relaxed">
                        {stage === 'input' ? "Upload screenshots to generate schedule." : 
                         stage === 'review' ? "Review timeline and adjust times." : 
                         "Worksheet saved."}
                    </p>
                </header>
                ...
                <div className="space-y-12 animate-in fade-in slide-in-from-bottom-8 duration-700">
                    <TimeSlotManager jobCount={jobCount} timeSlots={timeSlots} onTimeSlotsChange={setTimeSlots} addresses={extractedAddresses} />

                    <div className="grid xl:grid-cols-2 gap-8">
                        <div className="bg-black/20 backdrop-blur-xl rounded-3xl p-8 border border-white/5 shadow-2xl">
                            <h2 className="text-lg font-bold mb-6 text-slate-200">Extracted Data</h2>
                            {/* PASSING THE SYNCED TABLE HERE */}
                            <DataTable markdownTable={syncedDataTable} />
                        </div>
                        <div className="bg-black/20 backdrop-blur-xl rounded-3xl p-8 border border-white/5 shadow-2xl">
                            <h2 className="text-lg font-bold mb-6 text-slate-200">Notifications</h2>
