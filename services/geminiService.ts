...
if (!API_KEY) {
  // In the AI Studio preview environment, process.env.API_KEY is automatically injected.
  // If running locally, ensure you have set up your environment variables correctly.
