...
const timeOptions = (() => {
  const options = [];
  // 07:30 (450) to 22:00 (1320)
  for (let totalMinutes = 450; totalMinutes <= 1320; totalMinutes += 30) {
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-cyan-100 font-mono text-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 outline-none transition-all hover:bg-white/5 min-w-[120px]"
                    >
                ...
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 text-slate-400 font-mono text-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 outline-none transition-all hover:bg-white/5 min-w-[120px]"
                    >
                      {timeOptions.map(t => <option key={t} value={t}>{t}</option>)}
                    </select>
                  </div>
