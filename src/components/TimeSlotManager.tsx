            ...
            <div className="relative bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 rounded-2xl p-6 hover:border-cyan-500/30 transition-all duration-300 flex flex-col lg:flex-row lg:items-center gap-6 shadow-lg">
              ...
              <div className="flex-shrink-0 w-full lg:w-auto grid grid-cols-2 gap-4 border-t lg:border-t-0 lg:border-l border-white/5 pt-4 lg:pt-0 lg:pl-6">
                <div className="space-y-1">
                  ...
                  <div className="relative">
                    <select
                      ...
                      className="w-full bg-black/50 border border-white/10 rounded-xl px-4 py-3 text-cyan-100 font-mono text-lg focus:ring-2 focus:ring-cyan-500/50 focus:border-cyan-500 outline-none appearance-none disabled:opacity-50 disabled:cursor-not-allowed transition-all hover:bg-white/5 min-w-[120px]"
                    >
                ...
                <div className="space-y-1">
                  ...
                  <div className="w-full bg-slate-900/30 border border-white/5 rounded-xl px-4 py-3 text-slate-400 font-mono text-lg flex items-center min-w-[120px]">
                    {slot.end}
                  </div>
                </div>
              </div>
